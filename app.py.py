                ...
                <table class="w-full text-left text-xs border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100 font-sans text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50/80 divide-x divide-gray-50 transition-all duration-150">
                            ...
                            <td class="p-4"><span class="bg-slatematte-gold text-navyDark px-2.5 py-1 border border-gray-200 text-[10px] rounded-md font-mono font-bold">{{ r.crime_category }}</span></td>
                            <td class="p-4">
