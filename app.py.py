...
<body class="bg-slateblack text-black min-h-screen flex flex-col font-sans">
    <nav class="bg-luxury-navy text-black p-5 shadow-2xl flex justify-between items-center border-b-2 border-gold-gradient">
        <div class="flex items-center space-x-4">
            <div class="w-10 h-10 bg-gold-gradient rounded-full flex items-center justify-center font-black text-black text-xl shadow-lg border border-black/20">🚨</div>
            <div>
                <span class="font-extrabold tracking-widest text-sm block uppercase text-black">NATIONAL POLICE SERVICE — REPUBLC OF KENYA</span>
                <span class="text-[10px] tracking-widest text-black-400 block font-mono">DIGITAL OCCURRENCE BOOK & CASE COMMAND CORE</span>
            </div>
        </div>
        {% if current_user.is_authenticated %}
        <div class="flex items-center space-x-4 text-xs font-mono">
            <div class="bg-securityBlue border border-matteGold/30 px-4 py-2 rounded shadow-inner">
                <span class="text-black font-bold text-sm">{{ current_user.rank }} {{ current_user.full_name }}</span> 
            ...
            <a href="/logout" class="bg-gradient-to-r from-red-800 to-red-950 hover:from-red-900 hover:to-black transition-all text-black border border-red-700 px-4 py-2.5 rounded font-bold uppercase shadow-lg">Logout</a>
        </div>
        {% else %}
        <a href="/public-portal" class="bg-transparent text-black border border-matteGold text-xs font-bold px-4 py-2.5 rounded uppercase tracking-widest hover:bg-gold-gradient hover:text-navyDark transition-all duration-300 shadow-md">Public Portal Interface</a>
        {% endif %}
    </nav>
    <div class="flex flex-1 flex-col md:flex-row">
        {% if current_user.is_authenticated %}
        <div class="w-full md:w-64 bg-luxury-navy text-black p-5 space-y-4 border-r border-matteGold/10 flex flex-col justify-between shadow-2xl">
            <div class="space-y-2">
                <div class="text-[10px] uppercase font-black text-black tracking-widest px-2 mb-3 font-mono border-b border-matteGold/20 pb-1">Operations Command</div>
                <a href="/dashboard" class="block p-3 rounded text-xs uppercase font-bold tracking-wider hover:bg-securityBlue hover:text-black transition-all duration-200 border-l-4 border-transparent hover:border-matteGold">📊 Operations Dashboard</a>
                <a href="/occurrence-book" class="block p-3 rounded text-xs uppercase font-bold tracking-wider hover:bg-securityBlue hover:text-black transition-all duration-200 border-l-4 border-transparent hover:border-matteGold">📖 Occurrence Book (OB)</a>
                <a href="/suspect-registry" class="block p-3 rounded text-xs uppercase font-bold tracking-wider hover:bg-securityBlue hover:text-black transition-all duration-200 border-l-4 border-transparent hover:border-matteGold">👥 Suspect Intelligence Registry</a>
                
                <div class="text-[10px] uppercase font-black text-black tracking-widest px-2 pt-4 mb-3 font-mono border-b border-matteGold/20 pb-1">Intelligence & Reports</div>
                <a href="/reports" class="block p-3 rounded text-xs uppercase font-bold tracking-wider hover:bg-securityBlue hover:text-black transition-all duration-200 border-l-4 border-transparent hover:border-matteGold">📈 Statistical Analytics Hub</a>
                
                {% if current_user.role in ['Administrator', 'OCS'] %}
                <div class="text-[10px] uppercase font-black text-black tracking-widest px-2 pt-4 mb-3 font-mono border-b border-matteGold/20 pb-1">Administration Control</div>
                <a href="/officer-management" class="block p-3 rounded text-xs uppercase font-bold tracking-wider hover:bg-securityBlue hover:text-black transition-all duration-200 border-l-4 border-transparent hover:border-matteGold">👮 Command Force Roster</a>
                {% endif %}
...
def public_portal():
    ...
    <div class="max-w-2xl mx-auto bg-black rounded-xl shadow-2xl overflow-hidden mt-6 border border-matteGold/20">
        <div class="bg-luxury-navy p-6 text-black text-center font-bold text-sm uppercase tracking-widest border-b-2 border-gold-gradient text-black">
            ...
            <form method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <button type="submit" class="bg-luxury-navy hover:bg-securityBlue border border-matteGold/30 text-black font-extrabold px-6 py-3.5 rounded-lg text-xs uppercase tracking-widest transition-all duration-300 shadow-lg">
                            Verify File Status
                        </button>
                    </div>
                </div>
    ...
    <div class="text-center mt-8">
        <a href="/login" class="text-xs font-black uppercase text-securityBlue hover:text-black border-b border-dashed border-matteGold pb-0.5 tracking-widest font-mono transition-all duration-200">
...
def login():
    ...
    <div class="max-w-md mx-auto bg-black rounded-xl shadow-2xl overflow-hidden mt-12 border border-matteGold/20">
        <div class="bg-luxury-navy text-black p-6 text-center font-bold text-sm uppercase tracking-widest border-b-2 border-gold-gradient text-black">
        ...
        <form method="POST" class="p-6 space-y-4 bg-black">
            ...
            <button type="submit" class="w-full bg-luxury-navy hover:bg-securityBlue text-black font-black p-4 rounded-lg text-xs uppercase tracking-widest border border-matteGold/30 shadow-xl transition-all duration-300 mt-2">
...
def dashboard():
    ...
    <div class="space-y-6 font-sans">
        <h1 class="text-xl font-black text-navyDark uppercase tracking-widest border-b pb-3 border-matteGold/20 flex justify-between items-center">
            ...
            <span class="text-xs font-mono font-normal text-black bg-luxury-navy px-3 py-1 rounded border border-matteGold/30 shadow-inner">Operational Ready Suite</span>
        </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 pt-2">
            <div class="bg-black p-5 rounded-xl luxury-card text-center border border-matteGold/15">
                <div class="text-[10px] uppercase font-mono font-black text-black tracking-widest mb-1">Apprehensions</div>
            ...
            <div class="bg-black p-5 rounded-xl luxury-card text-center border border-matteGold/15">
                <div class="text-[10px] uppercase font-mono font-black text-black tracking-widest mb-1">Station Officers Force</div>
            ...
            <div class="bg-black p-5 rounded-xl luxury-card text-center border border-matteGold/15">
                <div class="text-[10px] uppercase font-mono font-black text-black tracking-widest mb-1">Vault Evidence files</div>
        ...
        <div class="bg-black p-6 rounded-xl luxury-card border border-matteGold/15">
            ...
            <div class="h-48 flex items-center justify-center bg-luxury-navy rounded-xl p-6 border border-matteGold/20 shadow-inner">
                <div class="w-full max-w-lg px-6 text-center space-y-3">
                    <p class="font-mono font-black text-black tracking-widest text-[11px]">REAL-TIME DATA-STREAM GRAPH MATRIX CAPTURED</p>
...
def occurrence_book():
    ...
    <div class="space-y-6">
        ...
        <div class="bg-black p-6 rounded-xl border border-matteGold/15 luxury-card">
            <h2 class="text-xs font-mono font-black uppercase mb-4 border-b pb-2 text-black tracking-widest flex items-center space-x-2">
            ...
            <form method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-mono">
                ...
                <button type="submit" class="md:col-span-3 bg-luxury-navy text-black border border-matteGold/30 font-black p-4 rounded-lg uppercase tracking-widest hover:opacity-90 text-xs transition-all duration-200 shadow-xl mt-2">
        ...
        <div class="bg-black border border-matteGold/10 rounded-xl luxury-card overflow-hidden">
            <div class="bg-luxury-navy p-4 text-black font-mono font-black text-xs uppercase tracking-widest border-b border-matteGold/20">
                    ...
                    <tbody class="divide-y divide-gray-100 font-sans text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50/80 divide-x divide-gray-50 transition-all duration-150">
                            ...
                            <td class="p-4 flex space-x-2 justify-center font-mono">
                                <a href="/case-workspace/{{ r.id }}" class="bg-luxury-navy text-black border border-matteGold/30 px-3 py-1.5 rounded-md text-[10px] font-bold uppercase tracking-wider hover:bg-securityBlue transition-all">Workspace</a>
    ...
    <div class="space-y-6">
        <div class="border-b pb-3 border-matteGold/20 flex justify-between items-center">
            <h1 class="text-xl font-black text-navyDark uppercase font-mono tracking-wide flex items-center">
                <span>🔍 Case Investigative Shell Terminal: <span class="text-black">{{ entry.ob_number }}</span></span>
            </h1>
            <span class="px-4 py-1.5 bg-luxury-navy border border-matteGold/30 text-black font-mono text-xs font-bold rounded-lg shadow-md">Jurisdiction Hub: {{ entry.station.name }}</span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 text-xs">
            <div class="bg-black p-5 border border-matteGold/10 rounded-xl luxury-card space-y-4 font-mono">
                <h3 class="font-black border-b border-matteGold/10 pb-2 text-black uppercase text-xs tracking-wider">Primary Core Parameters</h3>
                ...
                <div class="pt-3 border-t border-gray-100 space-y-4">
                    ...
                    <form action="/case-workspace/{{ entry.id }}/assign" method="POST" class="space-y-2 border-t border-gray-100 pt-3">
                        ...
                        <button type="submit" class="w-full bg-luxury-navy text-black border border-matteGold/30 font-bold py-2 rounded-lg uppercase text-[10px] tracking-widest hover:opacity-90 transition-all shadow-md">Mutate Investigator Link</button>
                    </form>
                    ...
                    <form action="/case-workspace/{{ entry.id }}/status" method="POST" class="space-y-2 border-t border-gray-100 pt-3">
                        ...
                        <button type="submit" class="w-full bg-amber-600 text-black font-black py-2 rounded-lg uppercase text-[10px] tracking-widest hover:bg-amber-700 transition-all shadow-md">Execute State Transition</button>
                    </form>
                    {% endif %}
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-black p-5 border border-matteGold/10 rounded-xl luxury-card space-y-4">
                    <h3 class="font-mono font-black border-b border-matteGold/10 pb-2 text-black uppercase text-xs tracking-wider">Linked Target Suspect Profile Associations</h3>
                    ...
                    <form action="/case-workspace/{{ entry.id }}/link-suspect" method="POST" class="flex space-x-2 border-t border-gray-100 pt-3 items-end">
                        ...
                        <button type="submit" class="bg-luxury-navy text-black border border-matteGold/30 px-5 py-2.5 font-mono rounded-lg text-xs font-bold uppercase tracking-widest hover:opacity-90 transition-all shadow-md">Bind Link</button>
                    </form>
                    {% endif %}
                </div>
                
                <div class="bg-black p-5 border border-matteGold/10 rounded-xl luxury-card space-y-4">
                    <h3 class="font-mono font-black border-b border-matteGold/10 pb-2 text-black uppercase text-xs tracking-wider">Chronological Case Ledger Matrix Journal</h3>
                    <div class="space-y-3 max-h-72 overflow-y-auto font-mono text-[11px] pr-1">
                        ...
                        <div class="p-3.5 bg-gray-50 border border-black rounded-lg shadow-inner space-y-1.5">
                            <div class="flex justify-between text-[9px] text-gray-400 font-black tracking-widest uppercase border-b border-black/60 pb-1">
                                ...
                                <span class="bg-luxury-navy border border-matteGold/20 text-black px-2 py-0.5 rounded text-[8px] tracking-wide">Actor: {{ note.recorded_by }}</span>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <button type="submit" class="bg-luxury-navy text-black border border-matteGold/30 font-black px-5 rounded-lg text-xs uppercase tracking-widest hover:opacity-90 transition-all shadow-md">Commit</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="bg-black p-5 border border-matteGold/10 rounded-xl luxury-card space-y-4">
                    <h3 class="font-mono font-black border-b border-matteGold/10 pb-2 text-black uppercase text-xs tracking-wider">🔒 Secure Vault Evidence Repository</h3>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 font-mono text-[10px]">
                        ...
                        <div class="bg-gray-50 border border-black p-3 rounded-lg text-center space-y-2 flex flex-col justify-between shadow-sm relative overflow-hidden">
                            <div class="w-full h-12 bg-luxury-navy text-black flex items-center justify-center font-black rounded-lg text-xl tracking-widest shadow-inner border border-matteGold/10">
                                📑
                            </div>
                            ...
                            <a href="/vault/download/{{ file.id }}" class="bg-luxury-navy hover:bg-securityBlue border border-matteGold/20 text-black text-[9px] py-1.5 rounded-md font-black block uppercase tracking-widest transition-all duration-150 shadow-sm">Retrieve File</a>
                        </div>
                        {% else %}
                    ...
                    <form action="/case-workspace/{{ entry.id }}/upload-evidence" method="POST" enctype="multipart/form-data" class="border-t border-gray-100 pt-3 flex items-end space-x-3 font-mono">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="file" name="evidence_payload" required class="w-full p-2 border text-xs bg-black rounded-lg outline-none luxury-input cursor-pointer file:mr-4 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-[10px] file:font-black file:uppercase file:bg-luxury-navy file:text-black file:cursor-pointer">
                        </div>
                        <button type="submit" class="bg-gradient-to-r from-emerald-700 to-emerald-900 border border-emerald-600 text-black font-black px-5 py-2.5 rounded-lg text-xs uppercase tracking-wider hover:opacity-95 transition-all shadow-md">
                            Upload Injection
                        </button>
                    </form>
                    {% endif %}
...
def suspect_registry():
    ...
    <div class="space-y-6">
        ...
        <div class="bg-black p-6 rounded-xl border border-matteGold/15 luxury-card">
            <h2 class="text-xs font-mono font-black uppercase mb-4 border-b pb-2 text-black tracking-widest">
            ...
            <form method="POST" class="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs font-mono">
                ...
                <button type="submit" class="md:col-span-4 bg-luxury-navy text-black border border-matteGold/30 font-black p-4 rounded-lg uppercase tracking-widest hover:opacity-90 text-xs transition-all duration-200 shadow-xl mt-2">
...
def officer_management():
    ...
    <div class="space-y-6 font-mono text-xs">
        <div class="bg-black p-6 rounded-xl border border-matteGold/15 luxury-card">
            <h2 class="text-xs font-black uppercase mb-4 border-b pb-2 text-black tracking-widest">
        ...
        <div class="bg-black border border-matteGold/10 rounded-xl luxury-card overflow-hidden">
            <div class="bg-luxury-navy p-4 text-black font-black text-xs uppercase tracking-widest border-b border-matteGold/20">
                        ...
                        <tr class="hover:bg-gray-50/80 divide-x divide-gray-50 transition-all duration-150">
                            ...
                            <td class="p-4 text-center font-mono">
                                <form method="POST" class="inline">
                                    ...
                                    <button type="submit" class="text-[9px] font-black uppercase px-3 py-1.5 bg-gray-100 border border-black hover:bg-luxury-navy hover:text-black hover:border-matteGold/30 rounded-lg transition-all shadow-sm">
...
def reports():
    ...
    <div class="space-y-6 font-mono text-xs max-w-xl mx-auto mt-6 bg-black p-6 border border-matteGold/15 rounded-xl luxury-card">
        <h2 class="text-sm font-black uppercase text-black border-b border-matteGold/10 pb-2 mb-4 tracking-widest text-center">
        ...
        <form method="POST" class="space-y-4 pt-4 border-t border-gray-100">
            ...
            <button type="submit" class="w-full bg-luxury-navy text-black border border-matteGold/30 font-black p-4 rounded-lg text-xs uppercase tracking-widest shadow-xl transition-all duration-200 mt-2 hover:opacity-90">
        ...
        <div class="bg-black border border-matteGold/10 rounded-xl luxury-card overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-left font-mono text-[11px] border-collapse">
                    <thead class="bg-luxury-navy text-black uppercase text-[9px] tracking-widest border-b border-matteGold/20">
